...
class BundlrStorageDriver {
    ...
    initBundlr() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const bundlr = (0, types_1.isKeypairSigner)(identity)
                ? this.initNodeBundlr(address, currency, identity, options)
                : yield this.initWebBundlr(address, currency, identity, options);
            try {
...
const bigNumberToAmount = (bigNumber) => {
    return (0, types_1.lamports)(new bn_js_1.default(bigNumber.decimalPlaces(0).toString()));
};
