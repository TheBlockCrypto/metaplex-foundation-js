...
class StorageClient {
    ...
    uploadJson(json) {
        return this.upload((0, MetaplexFile_1.useMetaplexFileFromJson)(json));
    }
    download(uri, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, MetaplexFile_1.useMetaplexFile)(buffer, uri);
        });
    }
    downloadJson(uri, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new errors_1.InvalidJsonStringError(error);
            }
        });
    }
}
