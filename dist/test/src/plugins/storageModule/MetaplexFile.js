...
exports.isMetaplexFile = exports.getBrowserFileFromMetaplexFile = exports.getBytesFromMetaplexFiles = exports.parseMetaplexFileContent = exports.useMetaplexFileFromJson = exports.useMetaplexFileFromBrowser = exports.useMetaplexFile = void 0;
...
const useMetaplexFileFromBrowser = (file, options = {}) => __awaiter(void 0, void 0, void 0, function* () {
    const buffer = yield file.arrayBuffer();
    return (0, exports.useMetaplexFile)(buffer, file.name, options);
});
...
const useMetaplexFileFromJson = (json, fileName = 'inline.json', options = {}) => {
    ...
    return (0, exports.useMetaplexFile)(jsonString, fileName, options);
};
