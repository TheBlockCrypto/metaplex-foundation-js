...
exports.TreasureDestinationOwnerRequiredError = exports.AuctionHouseError = void 0;
const errors_1 = require("../../errors");
class AuctionHouseError extends errors_1.MetaplexError {
    constructor(input) {
        super(Object.assign(Object.assign({}, input), { key: `plugin.auction_house.${input.key}`, title: `AuctionHouse > ${input.title}`, source: 'plugin', sourceDetails: 'AuctionHouse' }));
    }
}
...
class TreasureDestinationOwnerRequiredError extends AuctionHouseError {
    constructor(cause) {
        super({
            ...
            problem: 'You are trying to update an Auction House which uses a custom token as a treasury. ' +
            ...
            solution: 'Please provide the current "treasuryWithdrawalDestinationOwner" parameter so you can update the other fields.' +
