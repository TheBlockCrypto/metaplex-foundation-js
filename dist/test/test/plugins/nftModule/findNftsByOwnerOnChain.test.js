...
(0, tape_1.default)('it can fetch all NFTs in a wallet', (t) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const nfts = yield mx.nfts().findAllByOwner(owner);
    // Then we get the right NFTs.
    t.same(nfts.map((nft) => nft.name).sort(), ['NFT A', 'NFT B']);
    t.same(nfts.map((nft) => nft.mint.toBase58()).sort(), [nftA.mint.toBase58(), nftB.mint.toBase58()].sort());
}));
//# sourceMappingURL=findNftsByOwnerOnChain.test.js.map